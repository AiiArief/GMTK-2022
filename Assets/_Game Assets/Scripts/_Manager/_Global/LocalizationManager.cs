...
public class LocalizationManager : MonoBehaviour
{
    ...
    public static readonly LocalizationString TUTORIAL_SKIP = new LocalizationString("Rapidly tap to skip turn", "Tekan dua kali untuk lewati giliran");
    ...
    public static readonly LocalizationString TUTORIAL_UBIVISION_TOPFLOOR = new LocalizationString("Ubivision Top Floor", "Ubivision Lantai Paling Atas");
    #endregion
    ...
    public static readonly LocalizationString VW_ONLOAD_ENDGAME_2 = new LocalizationString(
        "It's proven that Ubivision has violated the following articles :",
        "Terbukti bahwa Ubivision telah melanggar beberapa pasal berikut :"
    );

    public static readonly LocalizationString VW_ONLOAD_ENDGAME_3 = new LocalizationString(
        "1) UU No. 80 Tahun 1957 tentang Pengupahan Yang Sama Bagi Buruh Laki-laki dan Wanita. (I'm too lazy to localize this lol)",
        "1) UU No. 80 Tahun 1957 tentang Pengupahan Yang Sama Bagi Buruh Laki-laki dan Wanita."
    );

    public static readonly LocalizationString VW_ONLOAD_ENDGAME_4 = new LocalizationString(
        "2) UU No. 7 Tahun 1984 tentang Penghapusan Segala Bentuk Diskiriminasi Terhadap Wanita. (I'm too lazy to localize this lol)",
        "2) UU No. 7 Tahun 1984 tentang Penghapusan Segala Bentuk Diskiriminasi Terhadap Wanita."
    );

    public static readonly LocalizationString VW_ONLOAD_ENDGAME_5 = new LocalizationString(
        "3) UU No. 21 Tahun 1999 mengenai Diskriminasi dalam Pekerjaan dan Jabatan. (I'm too lazy to localize this lol)",
        "3) UU No. 21 Tahun 1999 mengenai Diskriminasi dalam Pekerjaan dan Jabatan."
    );

    public static readonly LocalizationString VW_ONLOAD_ENDGAME_6 = new LocalizationString(
        "4) UU No. 13 Tahun 2003 Pasal 5 bahwa setiap tenaga kerja memiliki kesempatan yang sama tanpa diskriminasi untuk memperoleh pekerjaan. (I'm too lazy to localize this lol)",
        "4) UU No. 13 Tahun 2003 Pasal 5 bahwa setiap tenaga kerja memiliki kesempatan yang sama tanpa diskriminasi untuk memperoleh pekerjaan."
    );

    public static readonly LocalizationString VW_ONLOAD_ENDGAME_7 = new LocalizationString(
        "5) UU No. 13 Tahun 2003 Pasal 32 bahwa Laki-laki dan perempuan memiliki kesempatan yang sama dalam mendapatkan pelatihan. (I'm too lazy to localize this lol)",
        "5) UU No. 13 Tahun 2003 Pasal 32 bahwa Laki-laki dan perempuan memiliki kesempatan yang sama dalam mendapatkan pelatihan."
    );

    public static readonly LocalizationString VW_ONLOAD_ENDGAME_8 = new LocalizationString(
        "6) UU No. 13 Tahun 2003 Pasal 76 bahwa Perempuan dibawah 18 tahun tidak boleh kerja dari jam 23-7. (I'm too lazy to localize this lol)",
        "6) UU No. 13 Tahun 2003 Pasal 76 bahwa Perempuan dibawah 18 tahun tidak boleh kerja dari jam 23-7."
    );

    public static readonly LocalizationString VW_ONLOAD_ENDGAME_9 = new LocalizationString(
        "7) UU No. 13 Tahun 2003 Pasal 76 bahwa pengusaha harus memberikan makanan, minuman, dan keamanan jika perempuan kerja jam 23.00 - 07.00. (I'm too lazy to localize this lol)",
        "7) UU No. 13 Tahun 2003 Pasal 76 bahwa pengusaha harus memberikan makanan, minuman, dan keamanan jika perempuan kerja jam 23.00 - 07.00."
    );

    public static readonly LocalizationString VW_ONLOAD_ENDGAME_10 = new LocalizationString(
        "8) UU No. 13 Tahun 2003 Pasal 76 bahwa pengusaha harus memberikan transportasi jika perempuan pulang / berangkat kerja jam 23.00 - 05.00 (I'm too lazy to localize this lol)",
        "8) UU No. 13 Tahun 2003 Pasal 76 bahwa pengusaha harus memberikan transportasi jika perempuan pulang / berangkat kerja jam 23.00 - 05.00"
    );

    public static readonly LocalizationString VW_ONLOAD_ENDGAME_11 = new LocalizationString(
        "9) UU No. 13 Tahun 2003 Pasal 82 bahwa perempuan hamil berhak cuti 1.5 bulan sebelum atau sesudah melahirkan. (I'm too lazy to localize this lol)",
        "9) UU No. 13 Tahun 2003 Pasal 82 bahwa perempuan hamil berhak cuti 1.5 bulan sebelum atau sesudah melahirkan."
    );

    public static readonly LocalizationString VW_ONLOAD_ENDGAME_12 = new LocalizationString(
        "10) UU No. 13 Tahun 2003 Pasal 83 bahwa perempuan berhak menyusui anaknya ketika kerja. (I'm too lazy to localize this lol)",
        "10) UU No. 13 Tahun 2003 Pasal 83 bahwa perempuan berhak menyusui anaknya ketika kerja."
    );

    public static readonly LocalizationString VW_ONLOAD_ENDGAME_13 = new LocalizationString(
        "11) Permenaker Kerja No. PER/03/MEN/1989 bahwa dilarang phk perempuan karena nikah, hamil, atau melahirkan. (I'm too lazy to localize this lol)",
        "11) Permenaker Kerja No. PER/03/MEN/1989 bahwa dilarang phk perempuan karena nikah, hamil, atau melahirkan."
    );

    public static readonly LocalizationString VW_ONLOAD_ENDGAME_14 = new LocalizationString(
        "That is, at least, the law where I live.",
        "Seenggaknya itu peraturan di tempat gua tinggal."
    );

    public static readonly LocalizationString VW_ONLOAD_ENDGAME_15 = new LocalizationString(
        "Idk about you, because I am unable to locate your location haha.",
        "Auk deh lu gmana, gua kan ga bisa cek lokasi lu wkwk."
    );
    ...
    public static readonly LocalizationString VW_ONLOAD_ENDGAME_21 = new LocalizationString(
        ...
        "Gua pengen bilang, MAKASIH YA UDAH MAININ GAME GUA!"
    );
    ...
    public static readonly LocalizationString HW_DETAIL_3DSR_4 = new LocalizationString(
        "Why? Because I haven't implemented that mechanic yet.",
        "Kenapa? Karena gua memang belum sempet implementasiin mekanik tersebut."
    );

    public static readonly LocalizationString HW_DETAIL_3DSR_5 = new LocalizationString(
        "NYEHEHEHEHEHE.",
        "NYEHEHEHEHEHE."
    );

    public static readonly LocalizationString HW_DETAIL_3DSR_6 = new LocalizationString(
        "And, if you get caught by them, just do a time leap.",
        "Oiya, kalo lu ketangkep sama mereka, ntar lu tinggal time leap aja."
    );
    ...
    public static readonly LocalizationString HW_DETAIL_3DSR_10 = new LocalizationString(
        "So why are they using noise-cancelling headphones?",
        "Kenapa mereka semua menggunakan headphone noise cancelling?"
    );

    public static readonly LocalizationString HW_DETAIL_3DSR_11 = new LocalizationString(
    ...
    public static readonly LocalizationString HW_DETAIL_3DSR_12 = new LocalizationString(
        "NYEHEHEHEHE.",
        "NYEHEHEHEHE."
    );
    #endregion
    ...
    public static readonly LocalizationString HW_DETAIL_BD_8 = new LocalizationString(
        "Why? Because you need to find out yourself.",
        "Kenapa? Karena lu harus cari tau sendiri."
    );

    public static readonly LocalizationString HW_DETAIL_BD_9 = new LocalizationString(
        "NYEHEHEHEHE.",
        "NYEHEHEHEHE."
    );
    #endregion
    ...
    public static readonly LocalizationString HW_DETAIL_3DH_2 = new LocalizationString(
        "You're the best spy in this game.",
        "Lu adalah spy terbaik di game ini."
    );

    public static readonly LocalizationString HW_DETAIL_3DH_3 = new LocalizationString(
        "Maybe because you're the only spy in this game.",
        "Mungkin karena lu satu-satunya spy di game ini."
    );

    public static readonly LocalizationString HW_DETAIL_3DH_4 = new LocalizationString(
        "NYEHEHEHEHE.",
        "NYEHEHEHEHE."
    );

    public static readonly LocalizationString HW_DETAIL_3DH_5 = new LocalizationString(
        "Your class is from 3D Humanoid.",
        "Lu berasal dari kelas 3D Humanoid."
    );

    public static readonly LocalizationString HW_DETAIL_3DH_6 = new LocalizationString(
        "It's rare for any character from 3D Humanoid to be in this class, and you're probably the only one from this class.",
        "Character yang berasal dari kelas 3D Humanoid termasuk jarang, bahkan lu mungkin satu-satunya dari kelas ini."
    );

    public static readonly LocalizationString HW_DETAIL_3DH_7 = new LocalizationString(
        "Why? Because cost is too high.",
        "Kenapa? Karena budget buat bikinnya mahal."
    );

    public static readonly LocalizationString HW_DETAIL_3DH_8 = new LocalizationString(
        "Especially the animation, that's why there are a lot of clippings.",
        "Apalagi animasinya, makanya banyak yang clipping."
    );

    public static readonly LocalizationString HW_DETAIL_3DH_9 = new LocalizationString(
        "NYEHEHEHEHE.",
        "NYEHEHEHEHE."
    );

    public static readonly LocalizationString HW_DETAIL_3DH_10 = new LocalizationString(
        "Wait, because there are a lot of testers that don't know this, I need to tell you something.",
    ...
    public static readonly LocalizationString HW_DETAIL_3DH_12 = new LocalizationString(
        "Synchronous is a term that I made.",
        "Synchronous adalah term yang gua buat sendiri."
    );

    public static readonly LocalizationString HW_DETAIL_3DH_13 = new LocalizationString(
        "NYEHEHEHEHE.",
        "NYEHEHEHEHE."
    );

    public static readonly LocalizationString HW_DETAIL_3DH_14 = new LocalizationString(
        "Well, it's a turn based but players and enemies use their turn together.",
    ...
    public static readonly LocalizationString HW_DETAIL_2DH_7 = new LocalizationString(
        "Because I'm too lazy to design their character.",
        "Karena gua males ngedesain karakter-karakter mereka."
    );

    public static readonly LocalizationString HW_DETAIL_2DH_8 = new LocalizationString(
        "NYEHEHEHEHE.",
        "NYEHEHEHEHE."
    );
    ...
    public static readonly LocalizationString[] UV1_PASSWORD_CHOICES = new LocalizationString[4]
    {
        ...
        new LocalizationString("Roll the dices.", "Judi."),
    ...
    public static readonly LocalizationString UV1_DEVLOG2_0 = new LocalizationString(
        "I wanted to make this place as an old mansion.",
        "Ini tempat awalnya gua pengen bikin kayak mansion tua gitu."
    );

    public static readonly LocalizationString UV1_DEVLOG2_1 = new LocalizationString(
        "But because I'm not sure what to put in the mansion...",
        "Tapi karena gua ga tau mansion isinya apaan..."
    );

    public static readonly LocalizationString UV1_DEVLOG2_2 = new LocalizationString(
        "So I converted it to an office.",
        "Jadinya gua bikin jadi kantor aja."
    );
    #endregion

    #region DEVLOG 3
    public static readonly LocalizationString UV1_DEVLOG3_0 = new LocalizationString(
        "3D Sphere Robot's bed used to be like a mattress.",
        "Tadinya tempat tidurnya 3D Sphere Robot kayak kasur gitu."
    );

    public static readonly LocalizationString UV1_DEVLOG3_1 = new LocalizationString(
        "But there's no way robot like that sleep in a mattress.",
        "Masa iyak robot tidurnya di kasur, hadehhh."
    );

    public static readonly LocalizationString UV1_DEVLOG3_2 = new LocalizationString(
        "So I made a tube like in the lab for a place to sleep for them.",
        "Akhirnya gua buat kayak tabung di lab gitu deh buat tempat tidurnya."
    );
    #endregion
    ...
    public static readonly LocalizationString UV1_DEVLOG5_0 = new LocalizationString(
        "Idk what to do with this room.",
        "Aduh, gua gatau ruangan ini mau di isiin apaan."
    );

    public static readonly LocalizationString UV1_DEVLOG5_1 = new LocalizationString(
        "Warehouse? I don't know.",
        "Gudang kali ya, au ah."
    );

    public static readonly LocalizationString UV1_DEVLOG5_2 = new LocalizationString(
        "Like I said before, I often don't know what kind of furniture I should put with it lol.",
        "Gua sering gatau mau isi furniture apaan wkwkwk."
    );
    #endregion
    ...
    public static readonly LocalizationString UV1_DEVLOG6_4 = new LocalizationString(
        "Because I'm stupid at programming hahahahaha.",
    ...
    public static readonly LocalizationString UV1_DEVLOG7_0 = new LocalizationString(
        "I put this devlog diary here on purpose to make you panic.",
        "Devlog diary ini sengaja ditaro ditengah tengah sini biar lu panik."
    );

    public static readonly LocalizationString UV1_DEVLOG7_1 = new LocalizationString(
        "I purposefully designed the devlog diary like that; in order to make difficult lol.",
        "Devlog diary emang sengaja didesain biar nyusahin wkwk."
    );

    public static readonly LocalizationString UV1_DEVLOG7_2 = new LocalizationString(
        "Go ahead spam click / space.",
        "Sok atuh spam click / space nya."
    );
    #endregion

    #region DEVLOG 8
    public static readonly LocalizationString UV1_DEVLOG8_0 = new LocalizationString(
        "Boba Kotak is parodying a real person.",
        "Boba Kotak itu gua ngeparodi dari orang beneran."
    );

    public static readonly LocalizationString UV1_DEVLOG8_1 = new LocalizationString(
        "Ubivision also parodying 2 real companies.",
        "Perusahaan Ubivision juga ngeparodiin 2 perusahaan beneran."
    );

    public static readonly LocalizationString UV1_DEVLOG8_2 = new LocalizationString(
        "Their real name is... It's a secret!",
        "Nama aslinya... adadehhhh."
    );
    #endregion
    ...
    public static readonly LocalizationString UV1_DEVLOG9_6 = new LocalizationString(
        "NPC lore baybe.",
        "Beuh, NPC Lore."
    );
    #endregion
    ...
    public static readonly LocalizationString UV1_DEVLOG10_0 = new LocalizationString(
        "I'm not sure what should I write for this diary.",
        "Apalagi yak diarinya, ga tau nih."
    );

    public static readonly LocalizationString UV1_DEVLOG10_1 = new LocalizationString(
        "I wrote an NPC that is not sure what kind of question to ask for the password.",
        "Gua pernah naro NPC yang ga tau pertanyaan buat passwordnya apaan."
    );

    public static readonly LocalizationString UV1_DEVLOG10_2 = new LocalizationString(
        "At that time, I really don't know what to write hahahaha.",
        "Itu gua beneran ga tau mau nulis apaan wkwkwk."
    );
    #endregion
